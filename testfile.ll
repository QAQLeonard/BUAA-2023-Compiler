...
@.str = private unnamed_addr constant [10 x i8] c"21182621\0A\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0))
...
11:                                               ; preds = %5
  %12 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0))
  ret i32 0
}
